...
class CarServiceDetails extends StatefulWidget {
  final int adId;
  const CarServiceDetails({super.key, required this.adId});
...
class _CarServiceDetailsState extends State<CarServiceDetails>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<CarServicesProvider>().fetchCarServiceDetails(widget.adId);
    });
  }
  ...
  Future<void> _launchWhatsApp(String phoneNumber) async {
    ...
    if (cleanedNumber.isEmpty) {
      ...
      whatsappUrl =
          'https://wa.me/?text=${Uri.encodeComponent('مرحباً، أريد التواصل معك بخصوص الخدمة المعروضة')}';
    } else {
      // Open WhatsApp with specific number and invitation message
      whatsappUrl =
          'https://wa.me/$cleanedNumber?text=${Uri.encodeComponent('مرحباً، أريد التواصل معك بخصوص الخدمة المعروضة')}';
    }
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<CarServicesProvider>(
      builder: (context, provider, child) {
        ...
        if (provider.errorAdDetails != null) {
          return Scaffold(
            backgroundColor: Colors.white,
            body: Center(
              child: Column(
                ...
                children: [
                  Text("Error: ${provider.errorAdDetails}"),
                  ElevatedButton(
                    onPressed: () =>
                        provider.fetchCarServiceDetails(widget.adId),
        ...
        final car_service = provider.adDetails;
        if (car_service == null) {
          return const Scaffold(
            backgroundColor: Colors.white,
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: (car_service.thumbnailImages.isNotEmpty ||
                              ...
                              ? PageView.builder(
                                  ...
                                  itemCount:
                                      car_service.thumbnailImages.isNotEmpty
                        ...
                        Positioned(
                          ...
                          child: buildFavoriteIcon(
                            CarServiceAdItemAdapter(car_service),
                            onAddToFavorite: () {
                          ...
                          Positioned(
                            ...
                            child: Row(
                              children: List.generate(
                                  car_service.thumbnailImages.length, (index) {
                                return Container(
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                              ...
                              children: [
                                Row(
                                  children: [
                                    ...
                                    SizedBox(width: 6.w),
                                    Text(
                                      "${_formatPrice(car_service.price)} AED",
                                      style: TextStyle(
                                    ...
                                    const Spacer(),
                                    Text(
                                      car_service.createdAt?.split('T').first ??
                                          'N/A',
                                      style: TextStyle(
                                        color: Colors.grey,
                                        fontSize: 12.sp,
                          ...
                          SizedBox(height: 8.h),
                          LocationMap(
                            address: car_service.location ?? '',
                            markerTitle: car_service.title,
                            height: 188.h,
                          ),
                          SizedBox(height: 10.h),
                          Divider(
...
class CarServiceAdItemAdapter implements FavoriteItemInterface {
  ...
  @override
  String get location =>
      "${_carService.emirate}  ${_carService.area ?? ''}".trim();
  ...
  AdPriority get priority {
    if (_carService.planType == null ||
        _carService.planType!.toLowerCase() == 'free') {
